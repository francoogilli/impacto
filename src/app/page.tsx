  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between px-7 py-20">
      ...
      <div className="relative z-10 max-w-[58rem]">
        ...
        <div className="flex justify-center items-center cursor-pointer rounded-2xl bg-neutral-900 hover:bg-neutral-800 transition duration-300 border-2 border-neutral-800 max-w-[14rem] py-2 px-5 mb-7 md:mb-4 gap-x-3 mx-auto">
