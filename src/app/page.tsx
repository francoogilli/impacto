  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between px-7 py-20">
      ...
      <div className="relative z-10 max-w-[58rem]">
        ...
        <div className="flex justify-center items-center cursor-pointer rounded-[1.125rem] bg-neutral-900 hover:bg-zinc-800 hover:border-zinc-800 transition duration-300 border border-[#353535] max-w-[13rem] py-1.5 px-1 mb-7 md:mb-5 gap-x-3 mx-auto">
